...
const Astar = {
    ...
    diagonalSuccessors($N, $S, $E, $W, N, S, E, W, map, rows, cols, result, i) {
        if($N) {
    ...
    diagonalSuccessorsFree($N, $S, $E, $W, N, S, E, W, map, rows, cols, result, i) {
        $N = N > -1;
        $S = S < rows;
        $E = E < cols;
        $W = W > -1;
    ...
    nothingToDo($N, $S, $E, $W, N, S, E, W, map, rows, cols, result, i) {
        return result;
    },

    successors(find, x, y, map, rows, cols) {
        var
            N = y - 1,
            S = y + 1,
            E = x + 1,
